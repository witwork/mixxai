...
export interface ApiAiModelAiModel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    api_key: Schema.Attribute.String & Schema.Attribute.Private;
    model_name: Schema.Attribute.UID;
    conversations: Schema.Attribute.Relation<
      'oneToMany',
      'api::conversation.conversation'
    >;
    llm: Schema.Attribute.Enumeration<['openai', 'gemini']> &
...
export interface ApiChatMessageChatMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    conversation: Schema.Attribute.Relation<
      ...
      'api::conversation.conversation'
    >;
    report_message: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiReportMessageReportMessage
  extends Struct.CollectionTypeSchema {
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    nextPurchaseDate: Schema.Attribute.DateTime;
    receipt: Schema.Attribute.Text;
    users_permissions_user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    subscriptionId: Schema.Attribute.String & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
